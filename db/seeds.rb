...
Crust.create!(
  [
    { name: 'New hand tossed', stock_quantity: 5 },
    { name: 'Wheat thin crust', stock_quantity: 5 },
    { name: 'Cheese Burst', stock_quantity: 5 },
    { name: 'Fresh pan pizza', stock_quantity: 5 }
  ]
)
...
Topping.create!(
  [
    { name: 'Black olive', price: 20, category: :veg, stock_quantity: 5 },
    { name: 'Capsicum', price: 25, category: :veg, stock_quantity: 5 },
    { name: 'Paneer', price: 35, category: :veg, stock_quantity: 5 },
    { name: 'Mushroom', price: 30, category: :veg, stock_quantity: 5 },
    { name: 'Fresh tomato', price: 10, category: :veg, stock_quantity: 5 }
  ]
)
...
Topping.create!(
  [
    { name: 'Chicken tikka', price: 35, category: :non_veg, stock_quantity: 5 },
    { name: 'Barbeque chicken', price: 45, category: :non_veg, stock_quantity: 5 },
    { name: 'Grilled chicken', price: 40, category: :non_veg, stock_quantity: 5 }
  ]
)

# other Toppings
Topping.create!(name: 'Extra cheese', price: 35, category: :other, stock_quantity: 5)

# Sides
Side.create!(
  [
    { name: 'Cold drink', price: 55, stock_quantity: 5 },
    { name: 'Mousse cake', price: 90, stock_quantity: 5 }
  ]
)
